...
(0, _pie.default)(); // const app = document.querySelector('#app');
// app.innerHTML = header.header + footer.footer;
},{"./../styles/index.scss":"styles/index.scss","./components/pie":"scripts/components/pie.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
